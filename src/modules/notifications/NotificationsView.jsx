                                ...
                                <div className="flex items-start gap-4 min-w-0 flex-1">
                                    ...
                                    <div className="min-w-0 flex-1">
                                        <p className="font-bold text-blue-900 truncate">
                                            ...
                                            <span
                                                className="text-xs font-normal text-blue-600 ml-2 whitespace-nowrap">{notif.timestamp}</span>
                                        </p>
                                        <p className="text-sm text-blue-800 mt-1 truncate">{notif.text}</p>
                                    </div>
                                </div>
                                <div
                                    className="bg-white p-2 rounded-full shadow-sm text-blue-400 group-hover:text-blue-600 group-hover:translate-x-1 transition-all shrink-0">
